...
storiesOf('Diverse/Basic/Basic', module)
  .add('to Storybook', () => <Welcome showApp={linkTo('Diverse/Basic/Basic1')} />)
  .add('to first', () => {
    return <Test1
...
storiesOf('Diverse/Basic/Basic1', module)
  .add('to third', () => {
    return <Test1 showApp={linkTo('Diverse/Basic/Basic')} onClick={action('clicked2')}>xxxxxxx</Test1>;
  });
