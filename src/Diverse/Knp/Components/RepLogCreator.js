...
export default class RepLogCreator extends React.Component {
  constructor(props) {
   ...
   handleFormSubmit(e) {
     ...
     console.log(itemSelect.options[itemSelect.selectedIndex].value, quantityInput.value);
    ...
    return (
      <form onSubmit={this.handleFormSubmit}>
            <div className="form-group">
              ...
              <select ref={this.itemSelect} className="form-control" required="required">
            ...
            <div className={`form-group ${quantityInputError ? 'has-error' : ''}`}>
              ...
              <input type="number" id="rep_log_reps" ref={this.quantityInput} className="form-control" required="required" placeholder="How many times?"/>
            {quantityInputError && <span className="help-block">{quantityInputError}</span>}
            </div>
            <Button type="submit" className="btn-primary">Submit<span className="fa fa-plus-circle"></span></Button>
          </form>
    );
  }
}
